...
module.exports = class MiniBuffer {
        ...
        loadHistory() {
                ...
                var items = localStorage.getItem("sharapeco-mini-buffer:" + this.historyName);
                if (!items) {
                        return [];
                }
        ...
        saveHistory(newItem) {
                ...
                localStorage.setItem("sharapeco-mini-buffer:" + this.historyName, JSON.stringify(newHistory));
        }
